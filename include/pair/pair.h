 ...
 *     requests)
 */
struct pair_setup_context *pair_setup_new(enum pair_type type, const char *pin, pair_cb add_cb, void *cb_arg,
 ...
 */
int pair_setup(uint8_t **out, size_t *out_len, struct pair_setup_context *sctx, const uint8_t *in,
               size_t in_len);
 ...
 * free sctx.
 */
int pair_setup_result(const char **client_setup_keys, struct pair_result **result,
 ...
 */
struct pair_verify_context *pair_verify_new(enum pair_type type, const char *client_setup_keys,
                                            pair_cb get_cb, void *cb_arg, const char *device_id);
 ...
 * then set *in to NULL. Returns negative on error.
 */
int pair_verify(uint8_t **out, size_t *out_len, struct pair_verify_context *sctx, const uint8_t *in,
                size_t in_len);
 ...
 */
struct pair_cipher_context *pair_cipher_new(enum pair_type type, int channel, const uint8_t *shared_secret,
 ...
 * returned.
 */
ssize_t pair_encrypt(uint8_t **ciphertext, size_t *ciphertext_len, const uint8_t *plaintext,
                     size_t plaintext_len, struct pair_cipher_context *cctx);
 ...
 * returned.
 */
ssize_t pair_decrypt(uint8_t **plaintext, size_t *plaintext_len, const uint8_t *ciphertext,
                     size_t ciphertext_len, struct pair_cipher_context *cctx);
 ...
 */
int pair_add(enum pair_type type, uint8_t **out, size_t *out_len, pair_cb add_cb, void *cb_arg,
             const uint8_t *in, size_t in_len);

int pair_remove(enum pair_type type, uint8_t **out, size_t *out_len, pair_cb remove_cb, void *cb_arg,
                const uint8_t *in, size_t in_len);

int pair_list(enum pair_type type, uint8_t **out, size_t *out_len, pair_list_cb list_cb, void *cb_arg,
              const uint8_t *in, size_t in_len);
